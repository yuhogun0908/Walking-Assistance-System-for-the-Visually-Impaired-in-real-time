...
from yolormodel.utils.general import xyxy2xywh, xywh2xyxy
from yolormodel.utils.torch_utils import torch_distributed_zero_first
import pdb
...
class LoadImages:  # for inference
    def __init__(self, files, img_size=640, auto_size=32, roi=None):
    ...
    def __next__(self):
        ...
        # Padded resize
        img,_ , _ , recover_xy = letterbox(img0, new_shape=self.img_size, auto_size=self.auto_size, roi=self.roi)
        # recover_xy = img.copy()
        # Convert
...
def letterbox(img, new_shape=(640, 640), color=(114, 114, 114), auto=True, scaleFill=False, scaleup=True, auto_size=32, roi=None):
